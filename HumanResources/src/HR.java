...
public class HR {
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel<ItemType>(ItemType.values()));
	...
	void DoOnChange(JComboBox<ItemType> comboBox, JTextPane textPane, JScrollPane scrollPane){
		ResultSet rs = null;
		try {
